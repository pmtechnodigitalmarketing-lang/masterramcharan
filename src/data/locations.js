// Shared list of US states used by FindUs, StateServices, sitemap
// generation, and LocalBusiness areaServed schema.
...
export const stateSlugs = states.map((s) => slugify(s.name));
