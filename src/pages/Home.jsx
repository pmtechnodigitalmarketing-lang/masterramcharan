    ...
    <div className="fade-in-page">
      ...
      <section className="section mobile-p-sm mobile-pt-sm" style={{ minHeight: '90vh', display: 'flex', alignItems: 'center', paddingTop: '0' }}>
        <div className="container mobile-col mobile-text-center mobile-gap-sm" style={{ display: 'flex', alignItems: 'center', gap: '4rem' }}>
          <div className="hero-fade-in-up" style={{ flex: 1, width: '100%' }}>
          ...
          <div className="hero-fade-in-up mobile-w-full" style={{ flex: 1, position: 'relative', animationDelay: '0.2s' }}>
            ...
            <div className="mobile-hero-visual" style={{ position: 'relative', height: '600px', minHeight: '450px', width: '100%', borderRadius: 'var(--radius-xl)', overflow: 'hidden' }}>
              ...
              {/* Floating Glass Card */}
              <div
                className="glass-panel hero-glass-card hero-fade-in-up"
                style={{ position: 'absolute', bottom: '2rem', left: '2rem', right: '2rem', padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem', animationDelay: '0.4s' }}
              >
      ...
      <LazyComponent fallbackHeight="150px">
        {/* As Featured In */}
      ...
      <LazyComponent fallbackHeight="800px">
      ...
      <LazyComponent fallbackHeight="500px">
